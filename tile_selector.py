...
class TileSelector:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TileSelector_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Digital Terrain Model Tile Selector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TileSelector', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/tile_selector/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Download tile information from a selection of tiles.'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Digital Terrain Model Tile Selector'),
                action)
